...
<div id="header-top">
    <div class="container">
        <p class="left">西安乡村旅游网欢迎你！ |
            ...
            <c:if test="${nowuser.nickname!=null}"><a
                    href="../index/userDetail.do">${nowuser.nickname}</a> |<a href="../index/login.do">切换用户</a> </c:if>
        </p>
    </div><!-- end .container -->
</div><!-- end #header-top -->
                            ...
                            <c:forEach var="news" items="${newLists}">
                                ...
                                <li id="featured-slide-one" class="trip-content">
                                    ...
                                    <a href="../index/newsDetail.do?nid=${news.nid}">
                                        ...
                                        <h4 class="title"
                                            href="../index/newsDetail.do?nid=${news.nid}">${news.ntitle}</h4>
                                    </a>
            ...
            <c:forEach var="travelsMore" items="${travelsMoreLists}">
                ...
                <div class="entry">
                    ...
                    <div class="entry-content">
                        ...
                        <a href="../index/travelsDetail.do?tid=${travelsMore.travels.tid}"><img
                                src="../travels/${travelsMore.user.nickname}/${travelsMore.travels.present}2.png"
                                width="240" height="140" alt="" class="entry-image"/></a>
                        ...
                        <c:forEach var="userquestion" items="${userquestionList}">
                            ...
                            <li>
                                <a href="../index/questionDetail.do?qid=${userquestion.question.qid}" class="title">
                                    <img src="../user/${userquestion.user.nickname}/${userquestion.user.faceimg}"
