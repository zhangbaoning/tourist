				...
				<div id="main">
					...
					<div class="entry single">
						...
						<div class="entry-content">
							...
							<div class="zoom">
								<a class="single_image" href="${travelsphoto}"> <img
										src="${travelsphoto}" width="650" height="210"
					...
					<div class="list-page">
						...
						<c:if test="${!n1}">
							<li class="prev">
								<a
									href="../travelsDetail/changeDiscussPage.do?page=${nowPage-1}">上一页</a>
							</li>
						</c:if>
						...
						<c:if test="${!n2}">
							<li>
								<a class="next"
									href="../travelsDetail/changeDiscussPage.do?page=${nowPage+1}">下一页</a>
							</li>
						</c:if>
					</div>
					...
					<div id="respond" class="box">
						...
						<form method="post"
							action="../travelsDetail/insertDiscuss.do?type=3&&pid=${nowtravels.tid}&&uid=${nowuser.userid}"
