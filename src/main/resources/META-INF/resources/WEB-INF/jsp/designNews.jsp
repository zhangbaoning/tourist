    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="../designNews/mfindNews.do" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-content">
                	<div class="result-list">
						<a href="../designNews/insertNews.do"><i class="icon-font" > &#xe001;</i>添加新闻</a>
                    </div>
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach var="news"  items="${newLists}">
                        	...
                        	<td>${news.newphoto}</td>
                            <td>
                            	<a class="link-del"  href="../designNews/loadNews.do?nid=${news.nid}">详情|</a>
                            	<a class="link-del"  href="../designNews/deleteNew.do?nid=${news.nid}&&present=${news.present}&&newphoto=${news.newphoto}">删除</a>
                            </td>
                        	</tr>
                        </c:forEach>
                    </table>
                   <div class="list-page">
						...
						<c:if test="${!n1}">	
								<a href="../designNews/changeNewPage.do?page=${nowPage-1}">上一页</a>
						</c:if>
                    			第 ${nowPage} 页 /共 ${newPage} 页
                    	<c:if test="${nowPage eq newPage}"  var="n2" scope="request"></c:if>
                    	<c:if test="${!n2}">	
                    	<a href="../designNews/changeNewPage.do?page=${nowPage+1}">下一页</a>
                    	</c:if>
                    </div>
                </div>
            </form>
