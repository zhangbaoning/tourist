...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span>
            <span class="crumb-name">景点信息详情</span>
       		 </div>
        </div>
        <form enctype="multipart/form-data" onsubmit="return valiVeiwSpotNull();" action="../updateVeiw/updateVeiw.do?present=${nowveiw.present}&&veiwphoto=${nowveiw.veiwphoto}"  method="post">
         	<ul>
         		<p>填写下列信息：</p>
				<li>
                     <label >景点名称：</label>	
                     <input disabled="disabled" class="common-text required" id="vname" name="vname" size="18" value="${nowveiw.vname}" type="text" >
                	  <label >内容路径：</label>
                     <input disabled="disabled" class="common-text required" id="present" name="present" size="18" value="${nowveiw.present}" type="text" >
                     <label >图片根目录：</label>
                     <input disabled="disabled"class="common-text required" id="veiwphoto" name="veiwphoto" size="18" value="${nowveiw.veiwphoto}" type="text" >
                     <br>
                     <span style="color:#F00"  id="verror1"></span>
                </li>
				<li>
					<br>
					<label color="red">如有修改请重新上传(png格式)：</label><br>
					<br>
					<label>1.	我要修改第一张背景大图</label><br>
            		...
            		<div id="divPreview">
                       <img id="imgHeadPhoto"   name="imgHeadPhoto"  width="1010"  height="330" src="${veiwphoto1}">
            		</div>
            		<br>
            		<label>2.	我要修改第二张背景小图</label><br>
            		...
            		<div id="divPreview1">
                       <img id="imgHeadPhoto1" name="imgHeadPhoto1"  width="650"  height="210" src="${veiwphoto2}">
            		</div>
            		<br>
				</li>
				<li>
					<label>3.	我要修改该景点介绍内容</label><br>	
