...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span>
            <span class="crumb-name">添加新闻信息</span>
       		 </div>
        </div>
        <form enctype="multipart/form-data" onsubmit="return valiNewNull();" action="../insertNews/insertNewsOk.do"  method="post">
         	<ul>
         		<p>填写下列信息：</p>
				<li>
                     <label >新闻标题：</label>	
                     <input class="common-text required" id="ntitle" name="ntitle" size="22" value="" type="text" onblur="valiNtilte();">
                	  <label >新闻来源：</label>	
                     <input class="common-text required" id="quarry" name="quarry" size="22" value="" type="text" onblur="valiQuarry();">
                	  <br>
                	  <label >内容路径：</label>
                     <input class="common-text required" id="present" name="present" size="18" value="" type="text" onblur="valiNpresent();">
                     <label >图片根目录：</label>
                     <input class="common-text required" id="newphoto" name="newphoto" size="18" value="" type="text" onblur="valiNewphoto();">
                     <br>
                     <span style="color:#F00"  id="verror1"></span>
                </li>
				<li>
					<br>
					<label color="red">请上传三张符合规定的与新闻相关的图片(png格式)：</label><br>
					<br>
            		...
            		<div id="divPreview">
                       <img id="imgHeadPhoto"   name="imgHeadPhoto"  width="650"  height="210" src="">
            		</div>
            		<br>
            		...
            		<div id="divPreview1">
                       <img id="imgHeadPhoto1" name="imgHeadPhoto1"  width="242"  height="88" src="" >
            		</div>
            		<br>
            		...
            		<div id="divPreview2">
                       <img id="imgHeadPhoto2" name="imgHeadPhoto2"  width="60"  height="60" src="" >
            		</div>
            		<br>
				</li>
				<li>
